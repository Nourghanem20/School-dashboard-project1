...
import 'package:untitled11/presentation/screens/usernamePasswordScreen.dart';
import 'dart:html' as html;


import '../../business logic/cubits/teacher_cubit/cubit.dart';
import '../../business logic/cubits/teacher_cubit/states.dart';
import '../../data/models/teacherRegisterModel.dart';
        ...
        if (state is AppTeacherRegisterSuccessState) {
          navigateTo(
              ...
              UserNamePasswordScreen(
                registerModel: state.teacherRegisterModel,
              ));
            ...
            SnackBar(
              content: Padding(
                ...
                child: Container(
                    ...
                    child: Center(
                      child: Text(
                        state.teacherRegisterModel.message.toString(),
                        maxLines: 2,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Add Teacher',
                                style: TextStyle(
                                    fontSize: 50, color: AppColors.darkBlue),
                              ),
                              SizedBox(
                                height: 80,
                              ),
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: ConditionalBuilder(
                                        condition: state
                                            is! AppTeacherRegisterLoadingState,
                                        builder: (context) => defaultTextButton(
                                          ...
                                          function: () async {
                                            if (formKey.currentState!
                                              ...
                                              print(experienceYearsController
                                                  .text);
                                              print(AppTeacherWebCubit.get(
                                                      context)
                                                  .genderValue);
                                              print(dateOfBirth.text);
                                              print(selectedSubjects);

                                              RegisterModelTeacher model =
        ...
        children: [
          CircleAvatar(
            ...
            child: CircleAvatar(
                radius: 70.0,
                backgroundColor: Colors.white,
                backgroundImage: selectedImageInBytes == null
                    ? AssetImage(
                        "images/profile.png",
                      )
                    : MemoryImage(Uint8List.fromList(selectedImageInBytes!))
                        as ImageProvider
